...
create policy "lecture publique des images de promotions"
  on storage.objects for select
...
-- Seuls les vendeurs peuvent ajouter/supprimer des images de promotions
create policy "les vendeurs gèrent les images de promotions"
  on storage.objects for insert
  with check (
...
create policy "les vendeurs suppriment les images de promotions"
  on storage.objects for delete
  using (
    bucket_id = 'promo-images'
    and public.is_vendor()
